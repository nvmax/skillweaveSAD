...
2. Run the routing script `python skillweave.py "<user request>"` to decompose the request, retrieve matching candidate skills, and compose a DAG-ordered execution plan. Do NOT load `skill-index.json` manually in your context.
